# Used the original generate_paired_traj.py file - No changes were made
...
def read_pkl():
    pickle_path = os.path.dirname(os.path.realpath(__file__)) + '/validation20_feature_all.pkl'
...
def save_pairs_and_labels(pairs, labels, filename='X_Y_val20_pairs.pkl'):
